const VERSION = "20260705-ahlak-rehberim-v4-real-ui";
...
const I = {
  tr: {
    ...
    navHome:"Ana", navCompanies:"Firmalar", navCategories:"Kategoriler", navFavorites:"Favoriler", navAbout:"Bilgi",
    ...
    howSearch:"🔍 Nasıl Aranır?", howSearchText:"Arama kutusuna marka adı, ana firma, kategori veya alternatif ürün yazabilirsin.",
  ...
  en: {
    ...
    navHome:"Home", navCompanies:"Companies", navCategories:"Categories", navFavorites:"Favorites", navAbout:"About",
    ...
    howSearch:"🔍 How to Search", howSearchText:"Search by brand name, parent company, category or alternative product.",
  ...
  de: {
    ...
    navHome:"Start", navCompanies:"Firmen", navCategories:"Kategorien", navFavorites:"Favoriten", navAbout:"Info",
    ...
    howSearch:"🔍 So suchst du", howSearchText:"Suche nach Marke, Mutterfirma, Kategorie oder Alternative.",
...
function normalizeItem(raw,i){
  ...
  const hay=norm([marka,anaFirma,kod,kategori,alternatif,kaynak,not,statusLabel(status)].join(" "));
  return {marka,anaFirma,kod,kategori,alternatif,kaynak,not,status,hay};
}
...
function renderQuickActions(){
  ...
  quickActions.innerHTML=`
    <h2>${t("quickTitle")}</h2>
    <div class="quickGrid">
      <button data-go="companies" type="button"><span>🏢</span><b>${t("companies")}</b><small>${c.firmalar} ${t("companies").toLowerCase()}</small></button>
      <button data-go="categories" type="button"><span>📂</span><b>${t("categories")}</b><small>${c.kategoriler}</small></button>
      <button data-go="alternatives" type="button"><span>⭐</span><b>${t("withAlt")}</b><small>${c.altli} ${t("brands")}</small></button>
      <button data-go="favorites" type="button"><span>❤️</span><b>${t("favorites")}</b><small>${c.fav} ${t("brands")}</small></button>
    </div>`;
}
