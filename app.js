const VERSION="20260706-v19-ethical-guide-platform";
...
function showLegalNoticeOnce(){
  ...
  setTimeout(()=>{
    ...
    box.innerHTML=`<div class="legalModal"><h2>Ahlak Rehberim Bilgilendirme</h2><p>${esc(legalDisclaimerText())}</p><div class="legalActions"><button id="legalOk">Okudum ve Devam Ediyorum</button></div></div>`;
    document.body.appendChild(box);
    document.getElementById("legalOk").onclick=()=>{localStorage.setItem(key,"ok");box.remove();};
  },500);
}
function renderLegalFooter(){
  return `<div class="legalFooter"><b>Bilgilendirme:</b> ${esc(legalShortText())}<br>Bir kaydın hatalı olduğunu düşünüyorsanız düzeltme talebi gönderin ve kamuya açık kaynak ekleyin. <a href="hukuki-bilgilendirme.html">Hukuki Bilgilendirme</a> · <a href="kaynak-politikasi.html">Kaynak Politikası</a> · <a href="duzeltme-politikasi.html">Düzeltme Politikası</a></div>`;
}
